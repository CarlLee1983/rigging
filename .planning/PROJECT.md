...
- **Next:** `$gsd-new-milestone` 開 v1.2+（候選：PROD / SCAF / IDN — 見 `milestones/v1.1-REQUIREMENTS.md` Future 區）

## Next Milestone Goals

未承諾順序：Production Hardening（PROD-01..03）、Scaffold extraction（SCAF-01/02）、Extended Identity（IDN-01..03）。以 `$gsd-new-milestone` 收斂需求與 roadmap。
...
<!-- Next milestone — populate via $gsd-new-milestone + fresh REQUIREMENTS.md -->

- _(none — v1.1 requirements archive: `milestones/v1.1-REQUIREMENTS.md`)_

**Deferred to v1.2+（from v1.0/v1.1 候選池，待下個 milestone 重議）：**
...
---
*Last updated: 2026-04-20 — after v1.1 milestone close (archive + tag v1.1)*
