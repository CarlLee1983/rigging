...
- [ ] **CI-04**: CI 首跑綠燈（push + PR → GitHub Actions 3 jobs all green）
- [ ] **CI-05**: CI fail-mode 可觀測（驗證 lint/typecheck/test/drift 任一破壞時 gate 會擋）
...
- [ ] **OBS-01**: Observability smoke in CI（`createApp` boot + `/health` HTTP ping 作為 PR gate 最後一關）
...
---
*Last updated: 2026-04-20 — v1.1 Release Validation milestone started*
